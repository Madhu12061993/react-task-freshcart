        ...
        <>
            <div className="d-flex flex-row justify-content-between mt-4">
                ...
                <div className='col-6 d-flex gap-2'>
                    <div className='border search-box border-2 rounded-4  d-flex justify-content-between text-center '>
                        <input className='border-0 ps-3 outline-input ' type="text" placeholder="Search for products " />
                        <p className=' pe-4'><i className="bi bi-search"></i></p>
                    </div>
                    <div>
                        <button className='d-flex py-2 p-1 px-4 gap-2 border-1 rounded-3 bg-transparent'> <i className="bi bi-geo-alt"></i> Location</button>
                    </div>
                </div>
